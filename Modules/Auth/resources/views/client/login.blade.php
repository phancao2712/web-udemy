      ...
      <div class="row justify-center items-center">
        <div class="col-xl-6 col-lg-8">
          <div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
            ...
            <p class="mt-10">Bạn chưa có tài khoản? <a href="{{ route('client.register') }}" class="text-purple-1">Đăng kí miễn phí</a></p>
            ...
            <form class="contact-form respondForm__form row y-gap-20 pt-30" action="#">
              <div class="col-12">
                ...
                <input type="text" name="title" placeholder="abcc@gmail.com">
              </div>
              <div class="col-12">
