      ...
      <div class="row justify-center items-center">
        <div class="col-xl-8 col-lg-9">
          <div class="px-50 py-50 md:px-25 md:py-25 bg-white shadow-1 rounded-16">
            ...
            <p class="mt-10">Bạn đã có tài khoản? <a href="{{ route('client.login') }}" class="text-purple-1">Đăng nhập</a></p>
            ...
            <form class="contact-form respondForm__form row y-gap-20 pt-30" action="#">
              <div class="col-lg-6">
                ...
                <input type="text" name="title" placeholder="abc@gmai.com">
              </div>
              <div class="col-lg-6">
                <label class="text-16 lh-1 fw-500 text-dark-1 mb-10">Họ và tên *</label>
                <input type="text" name="title" placeholder="Nguyễn Văn A">
              </div>
              <div class="col-lg-6">
              ...
              <div class="col-12">
                <button type="submit" name="submit" id="submit" class="button -md -green-1 text-white fw-600 w-1/1">
                  Đăng kí
                </button>
              </div>
            </form>
