                        ...
                        <div class="card border shadow p-2 lift sk-fade">
                            ...
                            <div class="card-zoom position-relative">
                                ...
                                <a href="course-single-v5.html" class="card-img sk-thumbnail d-block">
                                    <img class="rounded shadow-light-lg" src="{{ $course->thumbnail }}" alt="...">
                                </a>
                            ...
                            <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                                ...
                                <div class="position-relative">
                                    <a href="course-single-v5.html" class="d-block stretched-link"><h4 class="line-clamp-2 h-md-48 h-lg-58 me-md-6 me-lg-10 me-xl-4 mb-2">{{ $course->name }}</h4></a>
