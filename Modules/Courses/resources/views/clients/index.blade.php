    ...
    <section class="layout-pt-md layout-pb-lg">
        <div data-anim-wrap class="container">
          ...
          <div class="row y-gap-30">
            ...
            <div data-anim-child="slide-up delay-{{ $course->slug }}" class="col-lg-4 col-md-6">
                  ...
                  <div class="h-100 pt-20 pb-15 px-30">
                    ...
                    <div class="d-flex x-gap-10 items-center pt-10">
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-14 lh-1">{{ getCountLesson($course)->module }} phần / {{ getCountLesson($course)->lesson }} bài học</div>
                      </div>
                      ...
                      <div class="d-flex items-center">
                        ...
                        <div class="text-14 lh-1">{{ getHour($course->durations) }}</div>
                      </div>
