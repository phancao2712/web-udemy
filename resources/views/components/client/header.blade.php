    ...
    <div class="row justify-between items-center">
        ...
        <div class="d-flex items-center">
            ...
            <a data-barba href="index.html">
                ...
                <img class="-dark-d-none" src="{{ asset('client/img/general/logo-dark.svg') }}" alt="logo">
            </a>
            </div>
        ...
        <div class="d-flex items-center">
            ...
            <div class="relative ">
                ...
                <div class="header-cart bg-white -dark-bg-dark-1 rounded-8">
                    ...
                    <div class="row justify-between x-gap-40 pb-20">
                        ...
                        <div class="row x-gap-10 y-gap-10">
                            <div class="col-auto">
                            <img src="{{ asset('client/img/menus/cart/2.png') }}" alt="image">
                            </div>
            ...
            <div class="relative">
                <a href="#" class="d-flex items-center justify-center size-50 rounded-16 -hover-dshb-header-light" data-el-toggle=".js-msg-toggle">
            ...
            <a href="#" data-el-toggle=".js-profile-toggle">
                <img class="size-50" src="{{ asset('client/img/misc/user-profile.png') }}" alt="image">
            </a>
