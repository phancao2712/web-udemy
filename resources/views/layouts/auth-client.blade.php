          ...
          <div class="col-auto">
            <div class="header-right d-flex items-center">
              ...
              <div class="header-right__buttons md:d-none">
                <a href="{{ url('/') }}" class="button -sm -rounded -dark-1 text-white">Trang chủ</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <section class="form-page js-mouse-move-container">
            <div class="form-page__img bg-dark-1">
              <div class="form-page-composition">
                <div class="-bg"><img data-move="30" class="js-mouse-move" src="{{ asset('client/img/login/bg.png') }}" alt="bg"></div>
                <div class="-el-1"><img data-move="20" class="js-mouse-move" src="{{ asset('client/img/home-9/hero/bg.png') }}" alt="image"></div>
                <div class="-el-2"><img data-move="40" class="js-mouse-move" src="{{ asset('client/img/home-9/hero/1.png') }}" alt="icon"></div>
                <div class="-el-3"><img data-move="40" class="js-mouse-move" src="{{ asset('client/img/home-9/hero/2.png') }}" alt="icon"></div>
                <div class="-el-4"><img data-move="40" class="js-mouse-move" src="{{ asset('client/img/home-9/hero/3.png') }}" alt="icon"></div>
              </div>
            </div>
